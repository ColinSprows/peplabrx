        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-100 leading-relaxed">
              ...
              your premium research compounds.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              <p>
                Peptides are short chains of amino acids linked by peptide bonds. They are 
                the building blocks of proteins and play crucial roles in biological processes.
              </p>
              <p>
                In research settings, synthetic peptides are used to study various biological 
                mechanisms, including cell signaling, hormone regulation, and tissue repair. 
                Their specificity and relatively small size make them valuable tools for 
                scientific investigation.
              </p>
              <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Common Research Applications</h3>
              <ul className="space-y-2">
                <li><strong>BPC-157:</strong> Studied for tissue healing and regeneration</li>
                <li><strong>TB-500:</strong> Research into wound healing and recovery</li>
                <li><strong>Semaglutide:</strong> Metabolic and appetite regulation studies</li>
                <li><strong>CJC-1295/Ipamorelin:</strong> Growth hormone release research</li>
                <li><strong>Melanotan 2:</strong> Melanogenesis and pigmentation studies</li>
              </ul>
              <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Reconstitution Guide</h3>
              <p>
                Most peptides come in lyophilized (freeze-dried) form and require reconstitution 
                before use. We recommend using bacteriostatic water for multi-use applications 
                or sterile water for single-use applications.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-accent-600 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-primary-100 mb-8 max-w-2xl mx-auto">
            Browse our catalog and find the perfect products for your research needs.
          </p>
          <Link
            href="/products"
