      ...
      <div className="bg-gradient-to-r from-primary-600 to-accent-600 text-white py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-primary-100 max-w-2xl">
            Browse our complete selection of premium research peptides, SARMs, and supplies. 
            All products are lab-tested with 99%+ purity.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <select
            ...
            className="px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white"
          >
            {categories.map(cat => (
