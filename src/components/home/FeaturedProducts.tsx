    ...
    <section className="py-20 bg-white border-b border-[#e5e5e5]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col md:flex-row md:items-end md:justify-between mb-12">
          <div>
            <span className="text-sm text-gray-500 mb-2 block">Popular Products</span>
          ...
          <Link href="/products" className="mt-6 md:mt-0 inline-flex items-center text-gray-900 hover:text-gray-600 text-sm font-medium transition-colors">
            View All Products
