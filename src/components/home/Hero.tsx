    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-primary-900 to-accent-900 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <span className="inline-block px-4 py-2 bg-accent-500/20 rounded-full text-accent-300 text-sm font-medium mb-6">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Lab-tested, USA-made peptides with 99%+ purity. Trusted by researchers 
              worldwide for quality and reliability. Free shipping on orders over $150.
            </p>

            <div className="flex flex-wrap gap-4 mb-12">
              <Link
                href="/products"
                className="inline-flex items-center px-8 py-4 bg-primary-500 hover:bg-primary-600 rounded-lg font-semibold transition-all transform hover:scale-105"
              >
                Shop All Products
              ...
              <Link
                href="/how-it-works"
                className="inline-flex items-center px-8 py-4 bg-white/10 hover:bg-white/20 rounded-lg font-semibold transition-all backdrop-blur-sm"
              >
                Learn More
              </Link>
            </div>
