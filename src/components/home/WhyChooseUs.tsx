    ...
    <section className="py-20 bg-cream-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* The Old Way */}
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-gray-100 rounded-3xl p-8">
            <h3 className="text-xl font-semibold text-gray-500 mb-6">The Old Way</h3>
          ...
          {/* The New Way */}
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-primary-500 rounded-3xl p-8 text-white">
            <h3 className="text-xl font-semibold mb-6">The PepLabRx Way</h3>
            <ul className="space-y-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mt-12">
          <Link href="/products" className="inline-flex items-center px-8 py-4 bg-gray-900 hover:bg-gray-800 text-white rounded-full font-medium transition-all shadow-lg hover:shadow-xl">
            Start Shopping
